...
if varargin{1}==0
    ...
    [pattern_string xydirection_string  mode_string  click_string] = tldMouse(varargin,bb);
    
    string = ['#' num2str(i) ', fps:' num2str(1/toc,3) ', ' num2str(tld.control.maxbbox) '/' num2str(tld.nGrid) ', pattern:' pattern_string ', xy:' xydirection_string ', mode:' mode_string ', click:' click_string];
